curl -G -d 'login42=aperin' -d 'username=alexis' ${import.meta.env.VITE_LOCAL_IP}:${import.meta.env.VITE_BACKEND_PORT}/user/add
curl -G -d 'login42=lbonnefo' -d 'username=lars' ${import.meta.env.VITE_LOCAL_IP}:${import.meta.env.VITE_BACKEND_PORT}/user/add
curl -G -d 'login42=hdelmas' -d 'username=hugo' ${import.meta.env.VITE_LOCAL_IP}:${import.meta.env.VITE_BACKEND_PORT}/user/add
curl -G -d 'login42=lyaiche' -d 'username=lucas' ${import.meta.env.VITE_LOCAL_IP}:${import.meta.env.VITE_BACKEND_PORT}/user/add
curl -G -d 'login42=yhuberla' -d 'username=yann' ${import.meta.env.VITE_LOCAL_IP}:${import.meta.env.VITE_BACKEND_PORT}/user/add

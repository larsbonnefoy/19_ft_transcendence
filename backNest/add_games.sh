...
curl -G -d 'player1=lbonnefo' -d 'player2=lucas' -d 'score1=3' -d 'score2=8' localhost:3000/match/add
curl -G -d 'player1=lbonnefo' -d 'player2=lucas' -d 'score1=3' -d 'score2=2' localhost:3000/match/add
curl -G -d 'player1=lbonnefo' -d 'player2=hugo' -d 'score1=3' -d 'score2=4' localhost:3000/match/add
curl -G -d 'player1=lbonnefo' -d 'player2=hugo' -d 'score1=3' -d 'score2=3' localhost:3000/match/add
curl -G -d 'player1=lbonnefo' -d 'player2=yann' -d 'score1=8' -d 'score2=0' localhost:3000/match/add
